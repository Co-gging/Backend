...
public class ReviewController {
    ...
    @PostMapping("/create")
    public Map<String, Integer> createReview(@AuthenticationPrincipal User user, @RequestBody ReviewCreateDto ReviewCreateDto){
        return Map.of("reviewId", reviewService.createReview(user, ReviewCreateDto));
    }
